                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $admin) {
                                ...
                                echo "<td>
                                        <a href='admin_edit.php?id={$admin['admin_id']}' class='btn btn-primary'>Edit</a>
                                        <a href='admin_delete.php?id={$admin['admin_id']}' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this admin?\")'>Delete</a>
                                      </td>";
                                echo "</tr>";
                            }
                            ?>
